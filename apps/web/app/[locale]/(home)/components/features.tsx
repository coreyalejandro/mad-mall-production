...
export const Features = ({ dictionary }: FeaturesProps) => {
  const Icon0 = featureIcons[0].icon;
  const Icon1 = featureIcons[1].icon;
  const Icon2 = featureIcons[2].icon;
  const Icon3 = featureIcons[3].icon;
      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <Icon1 className="h-8 w-8 stroke-1" style={{ color: '#fcfaf2' }} />
              <div className="flex flex-col">
                <h3
                  className="text-xl font-bold uppercase tracking-tight"
                  style={{ fontFamily: '"Space Grotesk", system-ui, sans-serif' }}
            ...
            >
              <Icon3 className="h-8 w-8 stroke-1" style={{ color: '#b38b4d' }} />
              <div className="flex flex-col">
                <h3
                  className="text-xl font-bold uppercase tracking-tight"
                  style={{ fontFamily: '"Space Grotesk", system-ui, sans-serif' }}
