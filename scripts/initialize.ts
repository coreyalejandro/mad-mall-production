...
const cloneProject = async (name: string, packageManager: string) => {
  const command = [
...
export const initialize = async (options: {
  ...
  try {
    intro("Let's start a MADMall project!");
    ...
    s.start("Cloning MADMall...");
    await cloneProject(name, packageManager);
