...
- [x] Dynamic Reset View with content bounds calculation

## Phase 2: Branding
- [ ] Replace next-forge branding throughout
- [ ] MADMall-specific header, footer, navigation
- [ ] Construction-themed identity (caution stripes, blueprint grid)
- [ ] Remove unused template features

## Phase 3: Features (5 Governed Slices)
- [ ] Sisterhood Lounge (real-time chat)
- [ ] Live Experiences (event scheduling)
- [ ] Service Directory (booking + payments)
- [ ] User Profiles & Avatars
- [ ] Content Moderation (AI-governed)

## Phase 4: Home Display
- [ ] Feature ML notebook highlights
- [ ] Constitutional governance visibility in UI
